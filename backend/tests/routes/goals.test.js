...
describe('Goals Routes', () => {
  ...
  describe('GET /api/goals', () => {
    it('should return default goals if user has no custom goals', async () => {
      ...
      expect(response.body.goals.interview_rate_target).toBe(0.30);
    ...
    it('should return custom goals if user has set them', async () => {
      ...
      expect(response.body.goals.interview_rate_target).toBe(0.40);
      expect(response.body.goals.offer_rate_target).toBe(0.10);
  ...
  describe('PUT /api/goals', () => {
    ...
    it('should use default values for missing fields', async () => {
      ...
      pool.query.mockResolvedValueOnce({
        rows: [{
          monthly_applications: 50,
          interview_rate_target: 0.30, // Default
