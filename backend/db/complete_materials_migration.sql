...
--
-- Run this file once to complete the migration
-- ======================================
...
SELECT 
    ...
    (SELECT COUNT(resume_id) FROM job_materials) AS jobs_with_resume,
    (SELECT COUNT(cover_letter_id) FROM job_materials) AS jobs_with_cover_letter,
