-- ======================================
-- COMPLETE CLEANUP: Remove All Old Materials Tables and Columns
-- ======================================
-- This removes:
-- 1. ALL old materials tables (application_materials, job_material_history, application_materials_history, job_application_materials)
-- 2. resume_id and cover_letter_id columns from jobs table
-- 3. resume_customization and cover_letter_customization columns from jobs table
-- ======================================
