...
function TabPanel({ children, value, index, ...other }) {
  return (
    <div role="tabpanel" hidden={value !== index} {...other}>
      {value === index && (
        <Box sx={{ p: 3, background: "transparent" }}>{children}</Box>
      )}
    </div>
  );
}
...
function KPICard({ title, value, subtitle, color = "#3b82f6" }) {
  return (
    ...
    >
      ...
      <Typography
        sx={{ fontSize: "2rem", fontWeight: 700, color, lineHeight: 1.2 }}
      >
        {value}
      </Typography>
      {subtitle && (
...
const StatisticsPage = () => {
  ...
  const getTimingChartData = () => {
    ...
    return Object.values(timingByWeekday).sort(
      (a, b) => weekdayOrder.indexOf(a.name) - weekdayOrder.indexOf(b.name)
    );
  };
  ...
  return (
    <Box className="statistics-layout">
      ...
      <Box className="statistics-header">
        <Typography className="statistics-main-title">
          Analytics Dashboard
        </Typography>
      ...
      <Box className="statistics-nav-container">
        <Box className="statistics-nav-group">
          ...
          <Box className="statistics-nav-group-tabs">
            <button
              className={`statistics-nav-tab analytics ${
                tabValue === 0 ? "active" : ""
              }`}
        ...
        <Box className="statistics-nav-group">
          ...
          <Box className="statistics-nav-group-tabs">
            <button
              className={`statistics-nav-tab compensation ${
                tabValue === 4 ? "active" : ""
              }`}
            ...
            >
              <span className="statistics-tab-icon">🔮</span>
              <span className="statistics-tab-text">
        ...
        <Box className="statistics-nav-group">
          ...
          <Box className="statistics-nav-group-tabs">
            <button
              className={`statistics-nav-tab career ${
                tabValue === 11 ? "active" : ""
              }`}
            ...
            <>
              ...
              >
                ...
                <KPICard
                  ...
                  value={`${stats?.avgTimeToOffer || 0} days`}
                  color="#f59e0b"
                />
                <KPICard
            ...
            <>
              ...
              {analysis.overallStats && (
                ...
                >
                  ...
                  <KPICard
                    ...
                    subtitle={`${(
                      (analysis.overallStats.overallOfferRate || 0) * 100
                  ...
                  <KPICard
                    ...
                    subtitle={`${(
                      (analysis.overallStats.overallRejectionRate || 0) * 100
              ...
              {analysis.overallStats?.totalApplications < 10 && (
                <Box sx={styles.warningCard}>
                  <strong>Limited Data:</strong> You have{" "}
                  {analysis.overallStats?.totalApplications || 0} applications.
              ...
              >
                ...
                >
                  <Box
                    sx={{ width: "100%", height: 260, position: "relative" }}
                  >
              ...
              {/* Timing Patterns */}
              <ChartCard
                title="Application Timing Patterns"
                icon="T"
                iconColor="#06b6d4"
              >
                <ResponsiveContainer width="100%" height={280}>
              ...
              {analysis.customizationData &&
                (analysis.customizationData.resume?.length > 1 ||
                  ...
                  >
                    ...
                    >
                      ...
                      {analysis.customizationData.coverLetter?.length > 1 && (
                        <Box>
                          ...
                          <ResponsiveContainer width="100%" height={200}>
                            <BarChart
                              data={analysis.customizationData.coverLetter}
                            >
                              <CartesianGrid
                                strokeDasharray="3 3"
                                stroke="#e5e7eb"
                    ...
                    <Typography
                      variant="caption"
                      sx={{ color: "#9ca3af", mt: 2, display: "block" }}
                    >
                      Track how resume and cover letter customization affects
                      your success rate. Set customization levels when
                      adding/editing jobs.
                    </Typography>
                  </ChartCard>
                )}
                ...
                {analysis.materialsData && analysis.materialsData.length > 0 ? (
                  ...
                  <Box sx={{ textAlign: "center", py: 4, color: "#9ca3af" }}>
                    <Typography variant="body2">
                      No resume data available. Link resumes to your job
                      applications to track effectiveness.
                    </Typography>
                  </Box>
                )}
              </ChartCard>
              ...
              {analysis.rejectionAnalysis &&
                analysis.rejectionAnalysis.totalRejections > 0 && (
                  <ChartCard
                  ...
                  >
                    <Box mb={2}>
                      <Chip
                        label={`Overall Rejection Rate: ${(
                          (analysis.rejectionAnalysis.overallRejectionRate ||
                            0) * 100
                        ).toFixed(1)}%`}
                        size="small"
                        sx={{
                    ...
                    <Box
                      ...
                      gap={3}
                    >
                      {analysis.rejectionAnalysis.rejectionRateByIndustry
                        ?.length > 0 && (
                        <Box>
                          <Typography
                            variant="caption"
                      ...
                      {analysis.rejectionAnalysis.rejectionRateByRoleType
                        ?.length > 0 && (
                        <Box>
                          <Typography
                            variant="caption"
                          ...
                          <ResponsiveContainer width="100%" height={180}>
                            <BarChart
                              data={analysis.rejectionAnalysis.rejectionRateByRoleType.map(
                                (item) => ({
                                  ...item,
