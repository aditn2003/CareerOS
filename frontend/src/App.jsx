...
// ---------- Admin Pages (Lazy) ----------
const ApiMonitoringDashboard = lazy(() =>
  import("./pages/Admin/ApiMonitoringDashboard")
);

const Networking = lazy(() => import("./pages/Networking/Networking")); // Professional Networking Management
        ...
        <Suspense fallback={<Spinner />}>
          <Routes>
            ...
            >
              ...
              />{" "}
              {/* 🆕 MOVED HERE */}
              <Route path="salary-research" element={<SalaryResearch />} />{" "}
              {/* 🆕 MOVED HERE */}
              <Route
